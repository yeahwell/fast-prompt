...
module.exports = {
  ...
  title: "fast-prompt",
  description: '简单快捷的prompt管理工具',
  // base: '/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  head: [ // 注入到页面<head> 中的标签，格式[tagName, { attrName: attrValue }, innerHTML?]
    ['link', { rel: 'icon', href: '/img/favicon.ico' }], //favicons，资源放在public文件夹
    ['meta', { name: 'keywords', content: 'fastprompt,prompt,chatgpt,deepseek' }],
    ...
    // 路径配置
  permalink: '/:slug.html', // 带日期的 permalink 格式
  permalinkPattern: /^posts\/(.*)/, // 匹配文章路径的正则表达式
  ...
  themeConfig: {
    nav: [
      { text: '首页', link: '/' },
      {
        text: '提示词', link: '/pages/guide/hello/llm.html', items: [
          { text: '什么是LLM大语言模型', link: '/pages/guide/hello/llm.html' },
          {
            text: '最佳实践', items: [
      ...
      {
        text: '文生图', link: '/pages/image/gtp4o/introduce.html', items: [
          { text: 'GTP-4o介绍', link: '/pages/image/gtp4o/introduce.html' },
          { text: '工具介绍', link: '/pages/image/gtp4o/tools.html' },
          { text: '提示词技巧', link: '/pages/image/gtp4o/gtp4o-prompt.html' },
          { text: 'gpt-image-gallery', link: '/pages/image/gtp4o/gpt-image-gallery.html' },
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, href: String}
      name: '沙漏', // 必需
      href: 'https://github.com/yeahwell/fast-prompt' // 可选的
    },
    social: { // 社交图标，显示于博主信息栏和页脚栏
      ...
      icons: [
        ...
        },
        {
          ...
          title: 'GitHub',
          link: 'https://github.com/yeahwell'
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
    ...
    footer: { // 页脚信息
      ...
      copyrightInfo: '沙漏 | MIT License', // 博客版权信息，支持a标签
    },
    htmlModules,
  },
  ...
  plugins: [
    ...
    [
      ...
      {
        hm: baiduCode || 'fc4104126d9a4fd4ef406b0ba6298527'
      }
    ],
